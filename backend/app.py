...
def run():
    ...
    parse_parser.add_argument("-p", "--annotation-prefix", help="Annotation prefix", type=str, default=ANNOTATION_PREFIX)
    parse_parser.add_argument("-o", "--output", help="Output file name", type=str, default=OUTPUT_ANNOTATIONS)

    # Arguments for convert command
    convert_parser.add_argument("-a", "--annotations", type=str, help="Path to the annotations file", default=OUTPUT_ANNOTATIONS)
    convert_parser.add_argument("-o", "--output", type=str, help="Path to the output file", default=OUTPUT_ENTITIES)
    ...
    if args.command == "parse":
        ...
        _parse_command(".", ANNOTATION_PREFIX, OUTPUT_ANNOTATIONS)
