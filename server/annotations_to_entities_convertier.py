...
class EntityInstance:
    def __init__(self, from_file: Optional[str] = None, identifier: Optional[str] = None, description: Optional[str] = None):
...
class Entity:
    def __init__(self, name: Optional[str] = None, instances: Optional[List[EntityInstance]] = None):
        self.name = name
        self.instances: List[EntityInstance] = instances if instances else []
...
class AnnotationsToEntitiesConverter:
    ...
    def _add_instance(self, name: Optional[str], instance: EntityInstance):
        ...
        new_instance = EntityInstance(instance.from_file, instance.identifier, instance.description)
        if entity:
            entity.instances.append(new_instance)
        else:
            self.entities.append(Entity(name=name, instances=[new_instance]))
